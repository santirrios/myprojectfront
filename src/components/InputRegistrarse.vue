<template>
    <div>
        <form class="bg-dark w-50 mt-5 mx-auto" v-on:submit.prevent="register">
            ...
            <button class="d-block btn btn-primary mx-auto my-4">Registrarse</button>
...
export default {
    ...
    methods:{
        register(){
            ...
            fetch('http://127.0.0.1:5001/vue-firebase-fbc54/us-central1/appp/register',{
                method:'post',
                body:userJson
            }).then((response)=>{
